...
const TransactionPage = () => {
  ...
  // when refresh the page TransactionPage(editing) the page will rerender but states will not be reevaluated , to change values according to the state changes, useEffect used
  useEffect(() => {
    if (data) {
      setFormData({
        description: data?.transaction?.description,
